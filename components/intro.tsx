  ...
  return (
    <section ref={ref} id='home' className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
        ...
        <div className='relative'>
          ...
          >
            <Image
              ...
              quality='95'
              priority={true}
              className='h-24 w-24 rounded-full object-cover object-left-bottom border-[0.35rem] border-white shadow-xl'
            />
          </motion.div>
      ...
      >
        ...
        >
          Bana ulaş <BsArrowRight className='opacity-70 group-hover:translate-x-1 transition' />
        </Link>
        ...
        <a
          ...
          download
        >
          CV'yi indir <HiDownload className='opacity-60 group-hover:translate-y-1 transition' />
        </a>
